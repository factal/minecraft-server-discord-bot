...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  ...
  return {
    ...
    minecraft: {
      process: {
        cwd: resolve(raw.MINECRAFT_CWD),
        javaPath: raw.MINECRAFT_JAVA_PATH,
        jarPath: raw.MINECRAFT_JAR_PATH,
        jvmArgs: raw.MINECRAFT_JVM_ARGS,
        serverArgs: raw.MINECRAFT_SERVER_ARGS,
